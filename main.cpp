...
int main(int argc, char *argv[]){
    ...
    for (int i = 0; i < NO_OF_PARTICLE; i++){ particles.emplace_back(rand()%WIDTH, rand()%HEIGHT, RADIUS, 100+rand()%155, 100+rand()%155, 100+rand()%155, 255); }
